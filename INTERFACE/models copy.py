...
#         db_table = 'Analysis - Fission Tracks'
...
#     class Meta:
#         managed = False  # Created from a view. Don't remove.
#         db_table = 'Lithology Description'
